import { ColorSource, Container, DestroyOptions, EventMode, Graphics, Optional, Point, PointData, Size, Ticker } from 'pixi.js';
...
export declare class ScrollBox extends Container {
     ...
     */
    isItemVisible(item: Container, padding?: number): boolean;
    /**
    ...
    protected revertClick(item: Container): void;
