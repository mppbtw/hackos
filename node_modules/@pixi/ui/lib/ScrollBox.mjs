import { Container, Ticker, Graphics, isMobile } from 'pixi.js';
...
class ScrollBox extends Container {
  ...
  resize(force = false) {
    ...
    if (this.borderMask && (force || this._dimensionChanged || this.lastWidth !== this.listWidth || this.lastHeight !== this.listHeight)) {
      ...
      this.borderMask.clear().roundRect(0, 0, this.__width, this.__height, this.options.radius | 0).fill(16711935).stroke(0);
      this.borderMask.eventMode = "none";
      const color = this.options.background;
      this.background.clear().roundRect(0, 0, this.__width, this.__height, this.options.radius | 0).fill({
        color: color ?? 0,
        alpha: color ? 1 : 1e-7
