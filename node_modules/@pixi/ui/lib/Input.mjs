import { Container, isMobile, Ticker, Text, Color, Sprite, Texture, NineSliceSprite, Graphics } from 'pixi.js';
...
class Input extends Container {
  ...
  init() {
    ...
    const colorSource = Color.isColorLike(this.options.textStyle.fill) ? this.options.textStyle.fill : 0;
