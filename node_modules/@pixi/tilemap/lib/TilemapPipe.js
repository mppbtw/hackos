...
class TilemapAdaptor {
  constructor() {
    __publicField(this, "pipe_uniforms", new pixi_js.UniformGroup({
      u_proj_trans: { value: new pixi_js.Matrix(), type: "mat3x3<f32>" },
...
class TilemapPipe {
  constructor(renderer, adaptor) {
    ...
    this.adaptor.init();
    this.indexBuffer = new pixi_js.Buffer({
  ...
  */
  createVb() {
    const geom = new TilemapGeometry.TilemapGeometry(this.indexBuffer);
  ...
  checkIndexBuffer(size) {
    ...
    this.indexBuffer.data = createIndicesForQuads(
      size,
      settings.settings.use32bitIndex ? new Uint32Array(totalIndices) : new Uint16Array(totalIndices)
    );
  }
...
exports.TilemapAdaptor = TilemapAdaptor;
exports.TilemapPipe = TilemapPipe;
//# sourceMappingURL=TilemapPipe.js.map
